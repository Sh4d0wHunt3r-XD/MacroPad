...
Media Controls: Ses artırma ve azaltma desteği.

Fast Connection: NimBLE kütüphanesi ile düşük RAM kullanımı ve anında bağlantı.
...
🖼️ Devre Şeması
MacroPad Circuit Diagram.png

📦 Kurulum Notları
1- PlatformIO kullanıyorsan platformio.ini dosyasını kontrol et.

1- NimBLE-Arduino ve ESP32-BLE-Keyboard kütüphanelerini kur.
